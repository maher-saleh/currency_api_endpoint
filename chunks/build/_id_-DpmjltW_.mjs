  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_Title, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`Nuxt 3 Store App | ${ssrInterpolate(unref(product_item)[0].title)}`);
                } else {
                  return [
                    createTextVNode("Nuxt 3 Store App | " + toDisplayString(unref(product_item)[0].title), 1)
                  ];
                }
              }),
              _: 1
            ...
            _push2(ssrRenderComponent(_component_Meta, {
              name: "description",
              content: unref(product_item)[0].description
      ...
      ssrRenderList(unref(filteredProducts), (p) => {
        _push(`<div class="product">`);
        _push(ssrRenderComponent(_component_product_component, {
          class: "product_card_component",
          product: p
        }, null, _parent));
        _push(`</div>`);
      });
      _push(`<!--]--><p class="description">${ssrInterpolate(unref(product_item)[0].description)}</p><!--]-->`);
    };
  }
};
...
//# sourceMappingURL=_id_-DpmjltW_.mjs.map

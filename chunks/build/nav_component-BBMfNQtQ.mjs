import { useSSRContext, computed, unref, withCtx, createTextVNode, defineComponent, ref, h, resolveComponent } from 'vue';
import { A as parseQuery, l as hasProtocol, n as joinURL, B as withTrailingSlash, C as withoutTrailingSlash } from '../_/nitro.mjs';
import { _ as _export_sfc, d as useRouter, n as nuxtLinkDefaults, e as resolveRouteObject, g as navigateTo, a as useNuxtApp, h as useRuntimeConfig } from './server.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<header${ssrRenderAttrs(_attrs)} data-v-5fba3f0b><nav data-v-5fba3f0b><h1 data-v-5fba3f0b>${ssrInterpolate(unref(capitalizedTitle))}</h1><div data-v-5fba3f0b><ul data-v-5fba3f0b>`);
      ...
      _push(`</ul><ul data-v-5fba3f0b>`);
      _push(ssrRenderComponent(_component_nuxt_link, { to: "/store" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`Store`);
          } else {
      ...
      _push(`</ul><ul data-v-5fba3f0b>`);
      _push(ssrRenderComponent(_component_nuxt_link, { to: "/currency" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`Currency`);
          } else {
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-5fba3f0b"]]);

export { __nuxt_component_0 as _ };
//# sourceMappingURL=nav_component-BBMfNQtQ.mjs.map
